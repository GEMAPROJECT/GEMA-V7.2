                                                ...
                                                <div class="wrap-contact100">          
                                                    <form class="contact100-form validate-form" method="post" action="Usuario">
                                                        ...
                                                        <div class="wrap-input100 validate-input bg1" data-validate="La Identificacion Es Obligatoria">
                                                            <span class="label-input100">Identificacion del Usuario*</span>
                                                            <input class="input100" type="text" name="Id_usuario" maxlength="20" placeholder="Escribe la Identificacion del Usuario">
                                                        </div>

                                                        <div class="wrap-input100 validate-input bg1 rs1-wrap-input100" data-validate="El nombre es obligatorio">
                                                            <span class="label-input100">Usuario*</span>
                                                            <input class="input100" type="text" onkeypress="return soloLetras(event)" maxlength="20" name="Usuario" placeholder="Escribe el Usuario">
                                                        </div>

                                                        <div class="wrap-input100 validate-input bg1 rs1-wrap-input100" data-validate="La contraseña es olbigatoria">
                                                            <span class="label-input100">Contraseña*</span>
                                                            <input class="input100" type="password" name="textPassword" maxlength="20" placeholder="Escribe la contraseña">
                                                        </div>
