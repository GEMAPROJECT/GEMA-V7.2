		...
		Ver Prestamos activos
                ...
                <thead>
                    <tr>
                        ...
                        <th>identificacion del empleado</th>
                        <th>identificacion del profesor </th>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>                
                            <a href="Finalizar_Prestamo.jsp?id=<%= PreVO.getId_detalle()%>&id2=<%= PreVO.getSerial()%>&id3=<%= PreVO.getNum_prestamo()%>" title="Finalizar">Finalizar prestamo</a>
                        </td>
