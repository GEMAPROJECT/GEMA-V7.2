                                                ...
                                                <div class="wrap-contact100">
                                                    <form class="contact100-form validate-form" method="post" action="Prestamos">
                                                        ...
                                                        <div class="wrap-input100 bg1 rs1-wrap-input100">
                                                            <span class="label-input100">Feha del prestamo</span>
                                                            <div>
                                                        ...
                                                        <div class="wrap-input100 bg1 rs1-wrap-input100">
                                                            <span class="label-input100">Fecha de devolucion del prestamo</span>
                                                            <div>
                                                        ...
                                                        <div class="wrap-input100 validate-input bg1" data-validate="La Hora Es Obligatoria">
                                                            <span class="label-input100">hora de entrega del prestamo:</span>
                                                            <div>
                                                        ...
                                                        <div class="wrap-input100 validate-input bg1" data-validate="La Hora Es Obligatoria">
                                                            <span class="label-input100">hora de devolucion del prestamo:</span>
                                                            <div>
